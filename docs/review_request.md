...
generated x86-64 ASM, 8086/DOS-oriented ASM emission, built-in DOS COM bootstrap
binary emission, an embedding API, a conformance corpus, and source-oriented
documentation. It is based on the
...
- generated C/ASM/DOS backend contract;
